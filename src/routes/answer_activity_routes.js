...
answerActivityRoutes.get('/get_all_answer_specific_activity/:activity_id', AnswerController.get_all_answer_specific_activity);
answerActivityRoutes.get('/get_all_student_missing_answer_specific_activity/:activity_id', AnswerController.get_all_student_missing_answer_specific_activity);
answerActivityRoutes.get('/get_specific_answer/:answer_id', AnswerController.get_specific_answer);
answerActivityRoutes.post('/add_answer/:activity_id/:student_id', AnswerController.create_answer);
