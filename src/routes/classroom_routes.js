...
classroomRoutes.get('/get_all_activities_specific_student_specific_classroom/:classroom_id/:student_id', ClassroomController.get_all_activities_specific_student_specific_classroom);
