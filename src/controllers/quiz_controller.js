...
export const get_all_quiz_specific_classroom = asyncHandler(
  async (req, res) => {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Failed to get all quizzes in specific classroom." });
    }
  }
);

export const get_specific_quiz_specific_answer = asyncHandler(
  async (req, res) => {
...
export const update_quiz_option = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    updatedQuiz.question_option = question_option
      ? question_option
      : updatedQuiz.question_option;
    updatedQuiz.title = title ? title : updatedQuiz.title;
    updatedQuiz.description = description
      ? description
      : updatedQuiz.description;
    updatedQuiz.submission_time = time_limit
      ? time_limit
      : updatedQuiz.submission_time;
...
export const update_quiz = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    updatedQuiz.grading_breakdown = grading_breakdown
      ? grading_breakdown
      : updatedQuiz.grading_breakdown;
